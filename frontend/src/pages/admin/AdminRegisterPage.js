...
//             setPasswordError(true);
//             setPasswordHelperText('Password must contain at least one special character');
//         } else {
...
//         if (name === 'password') {
//             setPasswordError(false);
//             validatePassword(value);  // Validate the password on change
//         }
//         if (name === 'adminName') setAdminNameError(false);
//         if (name === 'schoolName') setSchoolNameError(false);
//     };
...
//                                 autoComplete="current-password"
//                                 error={passwordError}
//                                 helperText={passwordError ? passwordHelperText : 'Password is required'}
//                                 onChange={handleInputChange}
//                                 InputProps={{
//                                     endAdornment: (
//                                         <InputAdornment position="end">
...
const AdminRegisterPage = () => {
    ...
    const handleInputChange = (event) => {
        ...
        if (name === 'email') {
            setEmailError(false);
            validateEmail(value); // Validate the email on change
        }
                    ...
                    >
                        ...
                        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 2 }}>
                            ...
                            <TextField
                                ...
                                autoComplete="email"
                                error={emailError}
                                helperText={emailError ? emailHelperText : 'Email is required'}
                                onChange={handleInputChange}
                            />
                            <TextField
                                margin="normal"
